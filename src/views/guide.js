...
const steps = [
  ...
  ['06', '記分、完賽與備份', '點擊「可開始」的節點輸入比分。賽程區只保留目前輪次，已完成對戰可在排行榜點選選手展開查看；瑞士制固定四輪，循環賽每人互打一次，連勝制則由勝者守擂、先連勝兩場者獲勝。'],
];
