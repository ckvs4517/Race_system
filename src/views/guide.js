...
export function guideView(isAdmin = false) {
  return `<section class="section-wrap page-section guide-page">
    ...
    <div class="guide-notes">
      <article><p class="kicker">BEFORE START</p><h2>開始前一定要確認</h2><ul><li>公開報名連結只提供收件，核准後才會進入正式名單</li><li>從賽事內查看報名名單時，「返回」會回到原賽事；上方報名管理則可選擇其他賽事</li><li>檢查賽制、戰鬥台與報到人數；未報到者不會排入賽程</li><li>名單移除一定要進入管理模式並再次確認</li></ul></article>
