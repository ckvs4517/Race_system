...
export function guideView(isAdmin = false) {
  return `<section class="section-wrap page-section guide-page">
    ...
    <div class="guide-notes">
      <article><p class="kicker">BEFORE START</p><h2>開始前一定要確認</h2><ul><li>私密填寫連結送出後直接進入正式名單，只應交給已確認資格的參賽者</li><li>關閉填寫或進入排程時舊網址會撤銷，原連結立即失效</li><li>在報到頁確認名稱與備註；電話末五碼、飲品或其他現場資訊都可直接寫在備註</li><li>檢查賽制、戰鬥台與報到人數；未報到者不會排入賽程</li><li>名單移除一定要進入管理模式並再次確認</li></ul></article>
