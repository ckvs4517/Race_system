...
const featureCards = [
  ...
  ['manage', icons.trophy, 'NEW EVENT', '建立賽事', '輸入選手名單，自動建立單淘汰賽程。', '開始建立'],
];

export function homeView(tournamentCount) {
  return `
    <section class="hero section-wrap">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          <button class="button button-primary" data-route="manage">建立新賽事 ${icons.arrow}</button>
